// src/features/categories/components/CategoryFormSkeleton.tsx
        ...
        <Card sx={{ p: { xs: 2, sm: 3 }, borderRadius: 4 }}>
            <Stack spacing={3}>
                <Grid container spacing={3}>
                    {/* Skeleton for Names (Arabic & English) */}
                    {[1, 2].map((item) => (
                    ...
                    {/* Skeleton for Slug & Status Switch */}
                    {[3, 4].map((item) => (
                        <Grid size={{ xs: 12, md: 6 }} key={item}>
